...
- **MCP tool server** — 37 tools for AI agent integration (Claude, Cursor, Codex, etc.)
...
The bundled `veh-mcp-server.exe` exposes 37 debugging tools via the Model Context Protocol, allowing AI agents to directly control the debugger.
