...
- **Register editing** — Modify register values directly from the Variables panel
...
- **MCP tool server** — 38 tools for AI agent integration (Claude, Cursor, Codex, etc.)
...
The bundled `veh-mcp-server.exe` exposes 38 debugging tools via the Model Context Protocol, allowing AI agents to directly control the debugger.
